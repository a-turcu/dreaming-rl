...
class DCGAN():
    ...
    def train(self, epochs, batch_size=128, save_interval=50):
        ...
        for epoch in range(epochs):
            ...
            # If at save interval => save generated image samples and metrics
            if epoch % save_interval == 0:
                self.save_imgs(epoch)
                save_graph_data(epoch_list, "epoch")
                save_graph_data(d_losses, "d_loss")
                save_graph_data(g_losses, "g_loss")
                save_graph_data(accs, "acc")
                epoch_list = []
                d_losses = []
                accs = []
                g_losses = []
